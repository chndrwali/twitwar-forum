...
describe('threadReducer function', () => {
  ...
  it('should return the thread with the new thread when given by UP_VOTE_THREAD action', () => {
    // arrange
    const initialState = [
      {
  ...
  it('should return the thread with the new thread when given by DOWN_VOTE_THREAD action', () => {
    // arrange
    const initialState = [
      {
        id: 'thread--ERMoiIVb_18Vf1t',
  ...
  it('should return the thread with the new thread when given by CLEAR_VOTE_THREAD action', () => {
    // arrange
    const initialState = [
      {
        id: 'thread--ERMoiIVb_18Vf1t',
