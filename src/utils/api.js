const api = (() => {
  ...
  async function toggleCommentThreads(id) {
  ...
  async function toggleUpVoteThreads(id) {
  ...
  async function toggleDownVoteThreads(id) {
  ...
  return {
    ...
    getAllThreads,
    createThreads,
    toggleCommentThreads,
    toggleUpVoteThreads,
    toggleDownVoteThreads,
    getDetailThreads,
    getLeaderboards,
  };
})();
